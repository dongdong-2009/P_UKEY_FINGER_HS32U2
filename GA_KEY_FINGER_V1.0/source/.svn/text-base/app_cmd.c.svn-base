...
//	if(memcmp(former_cmd,&g_APDU.CLA,4)==0)
//	{
//		g_same_cmd=1;
//	}
//	else
//	{
//		g_same_cmd=0;
//		memcpy(former_cmd,&g_APDU.CLA,4);
//	}
...
//	 	ret=0x6d00;
	...
	switch(cmd)
	{
		case 0x0050:ret=APP_CMD_DevAuth();break;
		case 0x0051:ret=APP_CMD_VeryfyPin();break;
		case 0x0084:ret=APP_CMD_GenRand();break;
		case 0x00D8:ret=APP_CMD_MatchFinger();	break;
		case 0x8011:ret=APP_CMD_EndInit();break;
		case 0x8020:ret=APP_CMD_CreatAPP();break;
		case 0x8022:ret=APP_CMD_EnumAPP();break;
		case 0x8026:ret=APP_CMD_OpenAPP();break;			
		case 0x8027:ret=APP_CMD_CloseAPP();break;
		case 0x8028:ret=APP_CMD_DeleteAPP();break;	
		case 0x8031:ret=APP_CMD_CryptInit();break;
		case 0x8032:ret=APP_CMD_Encrypt();break;
		case 0x8033:ret=APP_CMD_Decrypt();break;
		case 0x8046:ret=APP_CMD_Gen1024RSA();break;
		case 0x8047:ret=APP_CMD_Gen2048RSA();break;
		case 0x8052:ret=APP_CMD_GetPinInfo();break;
		case 0x8056:ret=APP_CMD_BlockPin();break;
		case 0x805C:ret=APP_CMD_ClearSecureState();break;
		case 0x8068:ret=APP_CMD_SetKeyNum();break;
		case 0x8086:ret=APP_CMD_1024RSADecrypt_Sign();break;
		case 0x8087:ret=APP_CMD_2048RSADecrypt_Sign();break;
		case 0x808A:ret=APP_CMD_1024RSAEncrypt_Verify();break;
		case 0x808B:ret=APP_CMD_2048RSAEncrypt_Verify();break;
		case 0x80A0:ret=APP_CMD_ImportKey();break;
		case 0x80A1:ret=APP_CMD_RSAEmportKey();break;
		case 0x80A2:ret=APP_CMD_SM2EmportKey();break;
		case 0x80A3:ret=APP_CMD_DestoryKey();break;
		case 0x80C1:ret=APP_CMD_ExportSM2keyA();break;
		case 0x80CD:ret=APP_CMD_ImportSM2KeyA();break;
		case 0x80CB:ret=APP_CMD_ImportSM2KeyB1();break;
		case 0x80CA:ret=APP_CMD_ReadTerminalInfo();break;
		case 0x80E1:ret=APP_CMD_CreatFile();break;
		case 0x80E2:ret=APP_CMD_DeleteFile();break;
		case 0x80E3:ret=APP_CMD_EnumFile();break;
		case 0x80E4:ret=APP_CMD_GetFileInfo();break;
		case 0x80B0:ret=APP_CMD_ReadFile();break;
		case 0x80B6:ret=APP_CMD_WriteFile();break;
		case 0x80D1:ret=APP_CMD_AppendFinger();break;
		case 0x80D2:ret=APP_CMD_DeleteFinger();break;
		case 0x80D3:ret=APP_CMD_ConnectFinger();break;
		case 0x80D4:ret=APP_CMD_GetFinger();break;
		case 0x80D5:ret=APP_CMD_GetFingerInfo();break;
		case 0x80D7:ret=APP_CMD_TemplateInit();break;	
		case 0x80F0:ret=APP_CMD_ExportRSAkeyA();break;
		case 0x80F2:ret=APP_CMD_ImportRSAkeyA();break;
		case 0x80F3:ret=APP_CMD_ImportRSAkeyB();break;
		case 0x80F4:ret=APP_CMD_ImportRSAkeyB1();break;
		case 0x845D:ret=APP_CMD_ChangeDevPin();break;
		case 0x845E:ret=APP_CMD_ChangePin();break;
		case 0x845F:ret=APP_CMD_UnlockPin();break;
		case 0x88CE:ret=APP_CMD_GenSM2Key();break;
		case 0x88C1:ret=APP_CMD_ExportSM2keyA();break;
		case 0x88C2:ret=APP_CMD_SM2GenKeyA();break;
		case 0x88C3:ret=APP_CMD_SM2Sign();break;
		case 0x88C4:ret=APP_CMD_SM2Verify();break;
		case 0x88C5:ret=APP_CMD_SM2Decrypt();break;
		case 0x88C6:ret=APP_CMD_SM2Encrypt();break;
		case 0x88C8:ret=APP_CMD_SM2GenKeyB();break;
		case 0x88CB:ret=APP_CMD_ImportSM2KeyB1();break;
		case 0x80CC:ret=APP_CMD_Hash();break;
		case 0x88CD:ret=APP_CMD_ImportSM2KeyA();break;
		case 0x9010:ret=APP_CMD_KeyInit();break;

		//自定义指令
		case 0x5A00:ret=APP_CMD_DevFormat();break;
		case 0x5A01:ret=APP_CMD_FactoryCMD();break;
		case 0x5A02:ret=APP_CMD_FingerprintTest();break;
		default:ret=0x6d00;break;
	}
	g_APDU.SW1 = ret>>8;
	g_APDU.SW2 = ret&0x00ff;
	return;		//2011.12.20	 		
